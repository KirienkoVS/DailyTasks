...
class BoyRecyclerAdapter(private val resultsList: List<Results>):
    RecyclerView.Adapter<BoyRecyclerAdapter.ResultsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ResultsViewHolder, position: Int) {
        ...
        holder.editButton.setOnClickListener {
            val action = BoyFragmentGeneralDirections.actionBoyFragmentGeneralToBoyFragmentHistory(bundleDate = holder.invisibleDate.text.toString())
